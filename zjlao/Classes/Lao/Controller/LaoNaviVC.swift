...
class LaoNaviVC: UINavigationController {
...
//        self.tabBarItem.image = UIImage(named: gotResourceInSubBundle("dx", type: "gif", directory: "face_img")!)?.withRenderingMode(UIImageRenderingMode.alwaysOriginal)
        self.tabBarItem.selectedImage  =  UIImage(named:"logo")?.withRenderingMode(UIImageRenderingMode.alwaysOriginal)
        
        self.tabBarItem.image = UIImage(named:"logoPressed")?.withRenderingMode(UIImageRenderingMode.alwaysOriginal)
