...
//        self.navigationController?.navigationItem.leftBarButtonItem = left
        ...
        add.addTarget(self , action: #selector(iconClick), for: UIControlEvents.touchUpInside)
        ...
        sift.addTarget(self , action: #selector(iconClick), for: UIControlEvents.touchUpInside)
