...
import UIKit
protocol GDMediaSectionFooterDelete : NSObjectProtocol {
    func seeMoreCmmments(mediaID:String)
}
class GDMediaSectionFooter: UITableViewHeaderFooterView {
    ...
    weak var delegate : GDMediaSectionFooterDelete?
