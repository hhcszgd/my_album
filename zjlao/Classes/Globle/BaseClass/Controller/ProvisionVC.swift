    ...
    class ProvisionVC: GDNormalVC , WKScriptMessageHandler ,  WKNavigationDelegate,WKUIDelegate {
        ...
        override func viewDidLoad() {
            ...
            self.naviBar.addSubview(self.naviBar.backBtn)
            self.naviBar.backBtn.addTarget(self, action:#selector(popToPreviousVC) , for:UIControlEvents.touchUpInside)
        ...
        func layoutsubviews() {
            ...
            print(GDNetworkManager.shareManager.token ?? "token bu cun zai ")
